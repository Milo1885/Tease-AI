...
#Region "------------------------------------------- Data -----------------------------------------------"
    ...
    <Category("Taunts")> Public Property ReturnStrokeTauntVal As List(Of Integer) = New List(Of Integer)
    ...
    <Category("Script")> Public Property ReturnFileText As List(Of String) = New List(Of String)
    ...
    Public Property domLevel As Decimal
    Public Property domEmpathy As Decimal
    ...
    Public Property GiveUpContinue As Boolean

    Public Property ReturnSubState As String
    Public Property ReturnState As List(Of String) = New List(Of String)
    Public Property ReturnFlag As Boolean

    Public Property numReturns As Integer = -1
...
#Region "----------------------------------- Get/Set Form1 Data -----------------------------------------"
    ...
    Friend Sub Activate(ByVal activateForm As Form1)
        ...
        With activateForm
            ...
            '▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼
            updateDomVariables()
            GiveUpContinue = My.Settings.GiveUpContinue
...
#End Region ' Get/Set Data
    ...
    Private Sub updateDomVariables()
        If (domLevel = 0) Then
            FrmSettings.domlevelNumBox.Value = My.Settings.DomLevel
            domLevel = FrmSettings.domlevelNumBox.Value
        Else
            FrmSettings.domlevelNumBox.Value = domLevel
        End If

        If (domEmpathy = 0) Then
            FrmSettings.NBEmpathy.Value = My.Settings.DomEmpathy
            domEmpathy = FrmSettings.NBEmpathy.Value
        Else
            FrmSettings.NBEmpathy.Value = domEmpathy
        End If

        If (StrComp("", orgasmAllow) = 0) Then
            FrmSettings.alloworgasmComboBox.Text = My.Settings.OrgasmAllow
            orgasmAllow = FrmSettings.alloworgasmComboBox.Text
        Else
            FrmSettings.alloworgasmComboBox.Text = orgasmAllow
        End If

        If (StrComp("", orgasmRuin) = 0) Then
            FrmSettings.ruinorgasmComboBox.Text = My.Settings.OrgasmRuin
            orgasmRuin = FrmSettings.ruinorgasmComboBox.Text
        Else
            FrmSettings.ruinorgasmComboBox.Text = orgasmRuin
        End If
    End Sub
End Class
